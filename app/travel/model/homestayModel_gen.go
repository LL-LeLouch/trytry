...
var (
	...
	cacheTrytryHomestayIdPrefix = "cache:trytry:homestay:id:"
)
...
func (m *defaultHomestayModel) Insert(ctx context.Context, session sqlx.Session, data *Homestay) (sql.Result, error) {
	...
	trytryHomestayIdKey := fmt.Sprintf("%s%v", cacheTrytryHomestayIdPrefix, data.Id)
...
func (m *defaultHomestayModel) FindOne(ctx context.Context, id int64) (*Homestay, error) {
	trytryHomestayIdKey := fmt.Sprintf("%s%v", cacheTrytryHomestayIdPrefix, id)
	var resp Homestay
	err := m.QueryRowCtx(ctx, &resp, trytryHomestayIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheTrytryHomestayIdPrefix, primary)
}
